...
<html>
	<head>
		...
		<title>Página de éxito | Magnus Home</title>
			...
			<div id="somos" class="contieneBG">
				<div class="container">
					<div class="row no-gutters align-items-center">
						<div class="col">
							<h1 class="titPage text-white">MUCHAS GRACIAS<br>POR CONFIAR EN NOSOTROS</h1>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="container">
				<div class="row justify-content-center">
					<div class="col-12 text-center">
						<h3 class="acentuado">Tu propiedad fue notificada con éxito</h3>
						<p>Nos alegra que confíes tu propiedad a Magnus Home. Somos un grupo profesional que sabrá ayudarte en el proceso de venta o arriendo.</p>
						<p>Estaremos comunicándonos contigo a la brevedad.</p>
					</div>
				</div>
			</div>
		</section>
