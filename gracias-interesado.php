			...
			<div id="somos" class="contieneBG">
				<div class="container">
					<div class="row no-gutters align-items-center">
						<div class="col">
							<h1 class="titPage text-white">MUCHAS GRACIAS<br>POR TU ESCRIBIRNOS</h1>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="container">
				<div class="row justify-content-center">
					<div class="col-12 text-center">
						<h3 class="acentuado">Tu mensaje fue enviado con éxito</h3>
						<p>Nos alegra que hayas encontrado una propiedad de tu agrado. Nos pondremos en contacto contigo a la brevedad para entregarte más información de la propiedad que visitaste.</p>
					</div>
				</div>
			</div>
		</section>
